#!/usr/bin/env node
/**
 * `linearwatch` CLI — Phase 1 placeholder (D-11).
 *
 ...
 */
const dashboardUrl = process.env.LINEARWATCH_PUBLIC_URL || 'http://localhost:3000';
// biome-ignore lint/suspicious/noConsoleLog: CLI placeholder must print to stdout
console.log('linearwatch CLI — Phase 1 placeholder.');
// biome-ignore lint/suspicious/noConsoleLog: CLI placeholder must print to stdout
