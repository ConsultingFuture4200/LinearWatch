...
/**
 * UI-SPEC §P2 stub pages — Lineage tab. Verbatim copy.
 *
 * The slot is reserved in P1 so links and bookmarks remain stable when
 * the real Lineage view ships in Phase 2 (Enrichment).
 */
export default function LineagePage(): React.JSX.Element {
  return (
    <main className="mx-auto max-w-screen-2xl px-6 py-12">
      <h1 className="text-[28px] font-semibold leading-tight">Lineage — available in Phase 2</h1>
